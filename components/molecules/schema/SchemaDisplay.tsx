...
import RequiredBadge from '../../atoms/badge/RequiredBadge'; // Needed for object properties
import DeprecatedBadge from '../../atoms/parameter/DeprecatedBadge';
import DefaultValueDisplay from '../../atoms/schema/DefaultValueDisplay';
import EnumValuesDisplay from '../../atoms/schema/EnumValuesDisplay';
import FormatBadge from '../../atoms/schema/FormatBadge';
import SchemaConstraints from '../../atoms/schema/SchemaConstraints';
...
interface SchemaDisplayProps {
  ...
  // Optional: for controlling recursion depth or detecting cycles
  // currentDepth?: number;
  // maxDepth?: number;
  className?: string;
}
...
const getItemTypeString = (itemSchemaOrRef: SchemaObject | ReferenceObject | undefined, components: OpenApiComponents | undefined): string => {
      ...
      <div className="flex items-start flex-grow mr-4">
        ...
        <div className="flex-grow pt-0">
          ...
          >
            ...
            {/* ... rest of header ... */}
            <span className="text-xs font-mono text-blue-700">{displayTypeString}</span>
...
const ExportedSchemaDisplay: React.FC<SchemaDisplayProps> = (props) => {
  return <SchemaDisplay {...props} _currentDepth={0} />;
};
