...
const PathDetailLayout: React.FC<PathDetailLayoutProps> = ({
  spec: inputSpec,
  className,
}) => {
  const { t } = useI18n();
  ...
  const { components, resolve } = useOpenApi(parsedSpec || emptySpec);
            ...
            <div className="flex-1">
              ...
              <div className="mb-8">
                <div className="flex items-center gap-3 mb-4">
                  <MethodLabel
                    method={selectedOperation.method as any}
                    className="text-sm"
                  />
                  <OperationPath
                ...
                {(selectedOperation.operation.summary ||
                  ...
                  <div className="my-8">
                    {selectedOperation.operation.summary && (
                      <h2 className="text-xl font-medium mb-2 dark:text-neutral-200">
                        {selectedOperation.operation.summary}
                      </h2>
                    )}
                    {selectedOperation.operation.description && (
                      <DescriptionDisplay
                        description={selectedOperation.operation.description}
                      />
                    )}
                  </div>
                )}
                ...
                {selectedOperation.operation.parameters &&
                  selectedOperation.operation.parameters.length > 0 && (
                    <ParametersSection
                ...
                {selectedOperation.operation.responses &&
                  Object.keys(selectedOperation.operation.responses).length >
                    0 && (
                    <ResponsesSection
          ...
          <div className="flex flex-col items-center justify-center min-h-[60vh]">
            <div className="text-center max-w-md">
              <h2 className="text-2xl font-semibold mb-4 dark:text-neutral-200">
                {t("Select an API endpoint")}
              </h2>
              <p className="text-neutral-600 dark:text-neutral-400">
                {t(
                  "Choose an API endpoint from the sidebar to view its details.",
                )}
              </p>
            </div>
          </div>
