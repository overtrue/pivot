...
export function isParameterObject(obj: unknown): boolean {
  return obj !== null && typeof obj === "object" && "name" in obj && "in" in obj;
}
...
export function isComponentObject(obj: unknown): boolean {
  return obj !== null && typeof obj === "object" && !("$ref" in obj) && !("type" in obj);
}
...
export function isExampleObject(obj: unknown): boolean {
  return (
    obj !== null && typeof obj === "object" && ("value" in obj || "externalValue" in obj)
  );
}
