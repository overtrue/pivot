 ...
 */
const SchemaExampleView = React.forwardRef<HTMLDivElement, SchemaExampleViewProps>(
  ({
    mediaType,
 ...
 */
const SchemaWithExampleViewer = React.forwardRef<HTMLDivElement, SchemaWithExampleViewerProps>(
  ({
    content,
    components,
    className = '',
...
export { SchemaExampleView, SchemaWithExampleViewer, type SchemaWithExampleViewerProps };
