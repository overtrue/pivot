...
export default function ExternalDocsDemo() {
  ...
  const sdkDocumentation = {
    description:
      "官方 SDK 文档和代码示例，支持 JavaScript、Python、PHP、Java 等多种语言",
  ...
  const changelog = {
    description:
      "API 版本更新记录和重大变更通知，帮助开发者了解最新功能和兼容性信息",
  ...
  const securityGuide = {
    description:
      "API 安全最佳实践，包含认证方式、权限管理、数据加密和安全合规指导",
  ...
  return (
    <div className="space-y-8 min-w-md">
      ...
      <div>
        ...
        <ExternalDocs url={changelog.url} description={changelog.description} />
      </div>
