import { OAuthFlowDetails } from "@/registry/default/ui/oauth-flow-details";
  ...
  return (
    <div className="space-y-8 min-w-md">
      ...
      <div>
        ...
        <OAuthFlowDetails flowName="Implicit" flow={implicitFlow} />
      </div>
      ...
      <div>
        ...
        <OAuthFlowDetails flowName="Device Code" flow={deviceCodeFlow} />
      </div>
      ...
      <div>
        ...
        <OAuthFlowDetails flowName="Enterprise" flow={enterpriseFlow} />
      </div>
      ...
      <div>
        ...
        <OAuthFlowDetails flowName="Mobile App" flow={mobileAppFlow} />
      </div>
    </div>
  );
}
