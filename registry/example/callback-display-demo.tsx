...
export default function CallbackDisplayDemo() {
  // 支付成功回调
  const paymentSuccessCallback: OpenAPIV3.CallbackObject = {
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  amount: {
                    type: "number" as const as OpenAPIV3.NonArraySchemaObjectType | OpenAPIV3.ArraySchemaObjectType,
                    description: "支付金额（分）",
                    example: 9999
                  },
                  currency: {
                ...
                properties: {
                  ...
                  errors: {
                    ...
                    items: {
                      type: "object" as const as OpenAPIV3.NonArraySchemaObjectType | OpenAPIV3.ArraySchemaObjectType,
                      properties: {
                        recordId: { type: "string" as const as OpenAPIV3.NonArraySchemaObjectType | OpenAPIV3.ArraySchemaObjectType },
